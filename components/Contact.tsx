  ...
  return (
    <section id="contact" className="py-24 bg-secondary">
      <div className="container mx-auto px-6 text-center">
        ...
        <a href="mailto:jane.doe@example.com" className="inline-block bg-accent text-white font-bold py-4 px-10 rounded-full hover:bg-blue-500 transition-all duration-300 shadow-lg text-lg">
          Say Hello
        </a>
